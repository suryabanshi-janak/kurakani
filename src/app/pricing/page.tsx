...
export default async function Page() {
  ...
  return (
    <>
      <Navbar />
      <MaxWidthWrapper className='max-w-5xl text-center mb-8 mt-24'>
        <div className='sm:max-w-lg mx-auto mb-10'>
          <h1 className='text-6xl font-bold sm:text-7xl'>Pricing</h1>
          <p className='mt-5 text-gray-600 sm:text-lg'>
            Whether&apos;re just trying out our service or need more, we&apos;ve
            got you convered.
          </p>
        </div>

        <div className='grid grid-cols-1 mt-12 gap-10 lg:grid-cols-2'>
          <TooltipProvider>
